...
\begin{table}[ht!]
	\begin{tabular}{ |l|p{7.8cm}|l|}
		...
		\hline
		$F_{k}$            & The replication strength for data $k$, $F_{k} \le L_{k}$. & $F_{k} \in \mathbb{R}^{+}$ \\
		\hline
...
\begin{table}[ht!]
	\begin{center}
		\begin{tabular}{c}
			...
			\includegraphics[width=.97\textwidth]{figures/writeWithoutReplica.png} \\
			\includegraphics[width=.97\textwidth]{figures/writeWithReplica.png}
		\end{tabular}
