...
\begin{table}[!ht]
	\begin{tabular}{|p{0.7cm}|p{5.8cm}|r| }
		...
		\hline
		\hline
			$DC$ & It is the set of all \glspl{dc}. $d$ identifies one of the \glspl{dc}, $d \in \{1,\dots, |DC|\}$. & $\mathbb{N}_{0} $\\
		\hline
			$AD$ & It is the set of all advertisement-campaigns. $a$ identify one of the ads, $a \in \{1,\dots, |AD|\}$. & $\mathbb{N}_{0}$ \\
		\hline
			$DV$ & It is the set of devices. $dv$ represents one of those devices, $dv \in \{1,\dots, |DV|\}$. & $\mathbb{N}_{0}$ \\
		\hline
			$Nodes$ & It is the set of nodes. $n$ represents one of those nodes, $n \in \{1,\dots, |Nodes|\}$. & $\mathbb{N}_{0}$ \\
		\hline
	\end{tabular}
	\vspace{.1cm}
...
\begin{multline} \label{eq:dc_counter}
	views(a, n) = \sum_{q \in Nodes}  verifiedViews(a, n, q) +\\ \frac{averageViews(a)}{|Nodes|} * (|Nodes| - 1)
\end{multline}
...
\begin{table}[!ht]
	\begin{tabular}{|p{6.5cm}|p{.2cm}|}
		...
		\hline
		\hline
			$verifiedViews(a, d, n)$ & $\mathbb{N}_{0}$ \\
		\hline
		...
		\hline
		\hline
			$targerMaxViews(a, d)$ & $\mathbb{N}_{0}$ \\
		\hline
...
Also Equation \ref{eq:dc_counter} can be generalised for many \glspl{dc} as shown in Equation \ref{eq:dc_total_counter}.  The last term of the Equation \ref{eq:dc_total_counter} is because the node $n$, which it is calculating the total, will have $verifiedViews(a, d, n)$ the real number of times the ad $a$ was shown by this node on \gls{dc} $d$.
\begin{multline} \label{eq:dc_total_counter}
	views(a, d) = \sum_{n \in Nodes_{d}}  verifiedViews(a, d, n) +\\ \frac{averageViews(a, d)}{|Nodes_{d}|} * (|Nodes_{d}| - 1)
\end{multline}
...
\begin{table}[!ht]
	\begin{tabular}{|p{6.5cm}|p{.2cm}| }
		...
		\hline
		\hline
			 $\Delta views(a, d, q)$ & $\mathbb{N}_{0}$ \\
		\hline
		...
		\hline
		\hline
			 $\Delta totalViewsDiscrepancy(a, d, q)$ & $\mathbb{N}_{0}$ \\
		\hline
