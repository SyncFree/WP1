...
\@x{ MapProduct ( map ) \.{\defeq}}%
 ...
 {\IF} s \.{=} \{ \} \.{\THEN} \{ \} \.{\ELSE} \.{\LET} y \.{\defeq}
 {\CHOOSE} x \.{\in} s \.{:} {\TRUE} \.{\IN} ( \{ y \} \.{\times} map [ y ] )
 \.{\cup} mp [ s \.{\,\backslash\,} \{ y \} ]}%
...
\@x{ Rank ( d ,\, g ,\, i ) \.{\defeq}}%
 ...
 \@x{\@s{179.62} \.{\IN} RankSets [ j \.{-} 1 ] \.{\cup} \{ x \.{\in}
 remaining \.{:} \A\, y \.{\in} remaining \.{:} scores [ d ] [ {\langle} g
 ,\, x {\rangle} ] \.{\geq} scores [ d ] [ {\langle} g ,\, y {\rangle} ] \}}%
...
\end{lcom}%
 ...
 {\rangle} ] ]}%
 \@x{\@s{105.73} \.{\land} \.{\LET} new\_vc \.{\defeq} [ d \.{\in} DC
 \.{\mapsto} Max ( vecclc [ {\langle} g ,\, p {\rangle} ] [ d1 ] [ d ] ,\,
 vecclc [ {\langle} g ,\, p {\rangle} ] [ d2 ] [ d ] ) ] \.{\IN}\@s{4.1}
 vecclc \.{'} \.{=} [ vecclc {\EXCEPT} {\bang} [ {\langle} g ,\, p {\rangle}
 ] [ d1 ] \.{=} new\_vc ]}%
\begin{lcom}{50.0}%
...
\@xx{}%
 ...
 ,\, g \.{\in} Games ,\, p \.{\in} Players \.{:} {\langle} g ,\, p {\rangle}
 \.{\in} GamePlayers \.{\implies} scores [ d1 ] [ {\langle} g ,\, p {\rangle}
 ] \.{=} scores [ d2 ] [ {\langle} g ,\, p {\rangle} ]}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 \.{\in} GamePlayers \.{\implies} ( \A\, d \.{\in} DC \.{:} vecclc [
 {\langle} g ,\, p {\rangle} ] [ d1 ] [ d ] \.{\leq} vecclc [ {\langle} g ,\,
 p {\rangle} ] [ d2 ] [ d ] ) ) \.{\implies} scores [ d1 ] [ {\langle} g ,\,
 {\CHOOSE} x \.{\in} Leaders ( d1 ,\, g ) \.{:} {\TRUE} {\rangle} ] \.{\leq}
 scores [ d2 ] [ {\langle} g ,\, {\CHOOSE} x \.{\in} Leaders ( d2 ,\, g )
 \.{:} {\TRUE} {\rangle} ]}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 21 03:38:40 \ensuremath{EEST} 2014 by \ensuremath{Suha
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Sep} 30
 20:42:31 \ensuremath{EEST} 2014 by \ensuremath{Suha
}%
\end{cpar}%
\end{lcom}%