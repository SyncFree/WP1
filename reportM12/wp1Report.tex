...
\section{Milestones in the Deliverable}
WP1.1 has reached the following milestone:
\begin{table}[ht!]
	\begin{tabular}{|l|p{7.1cm}|l|l|}
		\hline
		\textbf{Mil. no} & \textbf{Mil. name} & \textbf{Date due} & \textbf{Actual date}\\
		\hline
...
%\newpage
\appendix
%\section{Optimistic Control for a Critical System}
%\begin{figure}
%	\centering 
%	\includepdf[pages=-]{CriticalOptimisticEventualConsistency_0.1.pdf}
%\end{figure}
%\includepdf[pages={-}]{CriticalOptimisticEventualConsistency_0.1.pdf}
%\includepdf[pages=-]{CriticalOptimisticEventualConsistency_0.1.pdf}
